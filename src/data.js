...
export const CORTES_CERDO = [
  ...
  },
  {
    ...
    tiempo: "30–45 min",
    temperatura:    "Brasa media-alta",
    temperatura_en: "Medium to high heat",
...
export const ACHURAS = [
  {
    ...
    preparacion:    "Pinchar con tenedor si no los quiere muy jugosos",
    preparacion_en: "Pierce them with a fork if you don't want them too juicy.",
    tiempo: "40–60 min",
    temperatura:    "Brasa media-alta",
    temperatura_en: "Medium-high heat",
  ...
  },
  {
    ...
    preparacion:    "NO pinchar. Fuego fuerte, dar vuelta con cuidado. Hay que calentarlas",
    preparacion_en: "DO NOT pierce. Very high heat, turn carefully. You have to heat them",
    tiempo: "20–30 min",
    temperatura:    "Brasa muy alta",
    temperatura_en: "Very high heat",
  ...
  },
  {
    ...
    preparacion:    "Alimonar 5 min. Salar y poner a la parrilla.",
    preparacion_en: "Squeeze on some lemon 5 min. Season and place on grill.",
    tiempo: "60-90 min",
    temperatura:    "Brasa media-alta",
    temperatura_en: "Medium-high heat",
  ...
  },
  {
    ...
    preparacion:    "Limpiar muy bien. Trenzar. Marinar con limón y ajo media hora",
    preparacion_en: "Clean thoroughly. Braid. Marinate with lemon and garlic half an hour.",
    tiempo: "45–60 min",
    temperatura:    "Brasa media-alta",
    temperatura_en: "Medium-high heat",
  ...
  },
  {
    ...
    preparacion:    "Limpiar muy bien quitando la membrana (opcional). Remojar en agua y vinagre 50/50, y sal gruesa 30 min. Salar y poner a brasa baja. NO cocinar de más.",
    preparacion_en: "Clean thoroughly removing the membrane (optional). Soak in water with vinager 50/50 and salt for 30 min. Season and place on low heat. DO NOT overcook.",
    tiempo: "45–60 min",
    temperatura:    "Brasa baja-media",
    temperatura_en: "low-medium heat",
...
export const PREMIUM_CORTES = [
  {
    ...
    preparacion:    "Abrir en mariposa o enganchar al asador. Marinar con sal gruesa, ajo y limón la noche anterior. Comenzar con brasa baja solo poniendo carbon en cada una de las puntas y aumentar gradualmente cada hora añadiendo en el centro tambien de a poco.",
    preparacion_en: "Butterfly or spit-roast. Marinate with coarse salt, garlic and lemon the night before. Start with low-medium heat by only putting charcoal at each of the ends and gradually increase every hour by adding charcoal to the center little by little.",
    tiempo: "180–240 min",
    temperatura:    "Brasa baja-media constante",
    temperatura_en: "Constant low-medium heat",
...
export const METODOS_FUEGO = [
  {
    ...
    tiempo: "40–60 min",
    descripcion:    "El método más usado. Apila el carbón en forma de pirámide dejando espacio para el aire. Enciende desde abajo con papel y carton.",
  ...
  },
  {
    ...
    tiempo: "40–60 min",
    descripcion:    "Usa una chimenea de anillos papel. Enrrolla papel de diario formando anillos, 6/8 anillos. Ponlos en el medio y alrededor el carbon hasta el tope de la chimenea de anillos. Enciende el papel dese arriba. Al quemarse el papel la chimenea va a ceder y el carbon caera para seguir prendiendo. Uno de los métodos más eficiente.",
    descripcion_en: "Use a paper ring chimney. Roll newspaper into rings, about 6 or 8 rings. Place them in the center and fill the chimney with charcoal. Light the paper from the top. As the paper burns, the chimney will collapse and the charcoal will fall in to continue burning. One of the most efficient methods.",
  },
  {
    id: "minion",
    ...
    tiempo: "30–40 min",
    descripcion:    "Para cocción larga. Carbón frío alrededor y arriba, brasa encendida en el centro. El carbón se enciende lentamente manteniendo temperatura constante. Util para cuando necesitas mas carbon para cocciones largas",
    descripcion_en: "For long cooks. Cold charcoal around the outside and over, lit coals in the center. Charcoal lights slowly maintaining constant temperature. Useful when you need more charcoal for long cooking times",
  },
  {
    id: "leña",
    ...
    tiempo: "60-90 min",
    descripcion:    "El método tradicional. Usa maderas duras como quebracho o espinillo. Nunca maderas resinosas. Da más aroma y sabor. Como la piramide pero abajo maderas mas chicas y papel para ir prediendo las mas gruesas que estan arriba",
    descripcion_en: "The traditional method. Use hardwoods like quebracho or carob. Never resinous woods. Adds more aroma and flavor. Like a pyramid, but with smaller pieces of wood at the bottom and paper to light the thicker pieces at the top.",
  },
  {
    id: "infalible",
    titulo:    "Infalible",           titulo_en:    "infallible",
    emoji: "🙌", dificultad: "Muy Fácil", dificultad_en: "Very Easy",
    tiempo: "45–60 min",
    descripcion:    "Agarra un pan o algodon. 2 partes, enveverlas con un poco de alcohol, y ponerlas en una cama de carbon, encender el pan o o algodon y poner carbon encima.",
    descripcion_en: "Take a piece of bread or cotton. Cut it into two pieces, soak them in a little alcohol, and place them on a bed of charcoal. Light the bread or cotton and put charcoal on top.",
  },
];
...
export const SIMULACION_CORTES = [
  // ── VACUNO ──────────────────────────────────────────────────────────────────
  {
    ...
    eventos: [
      ...
      { min: 40, msg: "Dar vuelta. Poner de un costado.",                        msg_en: "Flip. Put on one side." },
      { min: 50, msg: "Dar vuelta. Poner del otro costado.",            msg_en: "Flip. Put on the other side." },
      { min: 60, msg: "Verificar cocción. Debe estar dorado y jugoso.",            msg_en: "Check doneness. Should be golden and juicy." },
      { min: 70, msg: "¡LISTO! Reposar 5 min antes de cortar.",                   msg_en: "DONE! Rest 5 min before slicing." },
    ],
  },
    {
    ...
    eventos: [
      ...
      { min: 15, msg: "Bajar la grilla 10 cm. El hueso debe estar dorándose.",     msg_en: "Lower grill 10 cm. Bone should be browning." },
      { min: 30, msg: "No mover aún. Escuchar el chisporroteo.",                   msg_en: "Don't move yet. Listen for the sizzle." },
      { min: 40, msg: "Dar vuelta.",                                               msg_en: "Turn over." },
      { min: 60, msg: "Dar vuelta de nuevo sobre los huesos.",                     msg_en: "Turn over again. Bone side down." },
      { min: 70, msg: "Dar vuelta por ultima vez.",                                msg_en: "Turn over one last time." },
      { min: 80, msg: "Verificar cocción. Debe estar dorado y jugoso.",            msg_en: "Check doneness. Should be golden and juicy." },
      { min: 90, msg: "¡LISTO! Reposar 5 min antes de cortar.",                   msg_en: "DONE! Rest 5 min before slicing." },
    ],
  },
  {
    id: "vacio", nombre: "Vacío", emoji: "🥩", color: "#7A1818", tiempo: 80,
    eventos: [
      { min: 0,  msg: "Vacío con grasa hacia abajo. Brasa media.",                msg_en: "Vacío fat side down. Medium heat." },
      { min: 20, msg: "La grasa debe estar derritiéndose bien. Mantener.",        msg_en: "Fat should be rendering well. Keep going." },
      { min: 40, msg: "Dar vuelta. La grasa dorada es buena señal.",              msg_en: "Flip. Golden fat is a good sign." },
      { min: 60, msg: "Verificar punto apretando con el dedo.",                  msg_en: "Check doneness by pressing with your finger." },
      { min: 80, msg: "¡LISTO! Cortar en diagonal contra la fibra.",             msg_en: "DONE! Slice diagonally against the grain." },
    ],
  },
  {
    id: "entraña", nombre: "Entraña", emoji: "🥩", color: "#9B2226", tiempo: 45,
    eventos: [
      { min: 0,  msg: "Fuego alto. Entraña limpia sin membrana.",                 msg_en: "High heat. Clean skirt steak without membrane." },
      { min: 20,  msg: "Dar vuelta. Debe tener buen sellado.",                     msg_en: "Flip. Should have a good sear." },
      { min: 35, msg: "Verificar punto. Debe ceder al tacto.",                    msg_en: "Check doneness. Should give when touched." },
      { min: 40, msg: "Casi lista. Retirar del fuego directo.",                   msg_en: "Almost done. Move away from direct heat." },
      { min: 45, msg: "¡LISTA! Cortar en tiras y servir de inmediato.",          msg_en: "DONE! Slice into strips and serve immediately." },
    ],
  },
  {
    id: "lomo", nombre: "Lomo", emoji: "🥩", color: "#AE2012", tiempo: 60,
    eventos: [
      ...
      { min: 10, msg: "Rotar 90°. Dorar parejo todo el cilindro.",               msg_en: "Rotate 90°. Brown evenly all around." },
      { min: 25, msg: "Rotar 90°. Dorar parejo todo el cilindro.",               msg_en: "Rotate 90°. Brown evenly all around." },
      { min: 35, msg: "Rotar 90°. Dorar parejo todo el cilindro.",               msg_en: "Rotate 90°. Brown evenly all around." },
      { min: 45, msg: "Rotar 90°. Dorar parejo todo el cilindro.",               msg_en: "Rotate 90°. Brown evenly all around." },
      { min: 50, msg: "Verificar punto presionando. Debe ceder levemente.",       msg_en: "Check doneness by pressing. Should give slightly." },
      { min: 60, msg: "¡LISTO! Reposar 5 min tapado con papel aluminio.",        msg_en: "DONE! Rest 5 min covered with foil." },
    ],
  },
  {
    id: "matambre", nombre: "Matambre", emoji: "🥩", color: "#C0392B", tiempo: 55,
    eventos: [
      { min: 0,  msg: "Matambre bien aplanado. Brasa media.",               msg_en: "Matambre well flattened. Medium heat." },
      { min: 15, msg: "Sin apuro. Cocción lenta es la clave.",                   msg_en: "No rush. Slow cooking is the key." },
      { min: 25, msg: "Dar vuelta con cuidado. Debe estar dorado.",              msg_en: "Flip carefully. Should be golden." },
      { min: 45, msg: "Verificar que esté cocido parejo en toda la superficie.", msg_en: "Check it's cooked evenly over the entire surface." },
      { min: 55, msg: "¡LISTO! Dejar reposar 5 min. Cortar en rodajas.",        msg_en: "DONE! Rest 5 min. Slice into rounds." },
    ],
  },
  {
    id: "bife-chorizo", nombre: "Bife de Chorizo", emoji: "🥩", color: "#922B21", tiempo: 60,
    eventos: [
      { min: 0,  msg: "Bife a temperatura ambiente. Brasa media. No tocar.",  msg_en: "Strip loin at room temperature. Medium heat. Don't touch." },
      ...
      { min: 25,  msg: "Dar vuelta otra vez.",                                  msg_en: "Flip again." },
      { min: 50, msg: "Verificar punto presionando. Jugoso al tacto.",           msg_en: "Check doneness by pressing. Juicy to the touch." },
      { min: 60, msg: "¡LISTO! Reposar 3 min. Solo sal gruesa.",                msg_en: "DONE! Rest 3 min. Just coarse salt." },
    ],
  },
  {
    id: "ojo-bife", nombre: "Ojo de Bife", emoji: "🥩", color: "#A93226", tiempo: 85,
    eventos: [
      { min: 0,  msg: "Lomo a temperatura ambiente. Brasa alta. Sellar fuerte.",  msg_en: "Lomo at room temperature. High heat. Sear hard." },
      { min: 4,  msg: "Dar vuelta. Costra formada. Bajar a brasa media.",         msg_en: "Flip. Crust formed. Lower to medium heat." },
      { min: 10, msg: "Rotar 90°. Dorar parejo todo el cilindro.",               msg_en: "Rotate 90°. Brown evenly all around." },
      { min: 30, msg: "Rotar 90°. Dorar parejo todo el cilindro.",               msg_en: "Rotate 90°. Brown evenly all around." },
      { min: 50, msg: "Rotar 90°. Dorar parejo todo el cilindro.",               msg_en: "Rotate 90°. Brown evenly all around." },
      { min: 70, msg: "Rotar 90°. Dorar parejo todo el cilindro.",               msg_en: "Rotate 90°. Brown evenly all around." },
      { min: 80, msg: "Verificar punto presionando. Debe ceder levemente.",       msg_en: "Check doneness by pressing. Should give slightly." },
      { min: 85, msg: "¡LISTO! Reposar 5 min tapado con papel aluminio.",        msg_en: "DONE! Rest 5 min covered with foil." },
    ],
  },
  {
  ...
  {
    id: "colita-cuadril", nombre: "Colita de Cuadril", emoji: "🥩", color: "#CA6702", tiempo: 75,
    eventos: [
      { min: 0,  msg: "Grasa hacia abajo primero. Brasa media.",                 msg_en: "Fat side down first. Medium heat." },
      { min: 40, msg: "Dar vuelta. La grasa está dorada.",                       msg_en: "Flip. Fat is golden." },
      { min: 55, msg: "Verificar punto. Debe estar firme con algo de jugo.",     msg_en: "Check doneness. Should be firm with some juiciness." },
       { min: 65, msg: "Dar vuelta para mejor coccion",     msg_en: "Flip for better cook" },
      { min: 75, msg: "¡LISTA! Cortar en lonchas finas.",                       msg_en: "DONE! Slice thinly." },
    ],
  },
  // ── CERDO ────────────────────────────────────────────────────────────────────
  {
    ...
    eventos: [
      { min: 0,  msg: "Bondiola marinada. Fuego bajo.",                          msg_en: "Marinated bondiola. Low heat." },
      { min: 30, msg: "Dar vuelta. Color dorado. Mantener fuego bajo.",          msg_en: "Flip. Golden color. Keep low heat." },
      { min: 50, msg: "Rociar con la marinada de limon. Subir fuego levemente o bajar grilla.", msg_en: "Baste with lemon. Raise heat slightly. o bajar grilla" },
      { min: 70, msg: "Dar vuelta nuevamente. Perfumar con romero.",             msg_en: "Flip again. Perfume with rosemary." },
      { min: 85, msg: "Casi lista. Verificar temperatura interna.",              msg_en: "Almost done. Check internal temperature." },
      { min: 90, msg: "¡LISTA! Reposar 10 min. Cortar en lonchas gruesas.",     msg_en: "DONE! Rest 10 min. Slice thick." },
    ],
  },
  {
    id: "costillas-cerdo", nombre: "Costillas de Cerdo", emoji: "🐷", color: "#E09F3E", tiempo: 80,
    eventos: [
      { min: 0,   msg: "Costillas con el hueso hacia abajo. Brasa media.",    msg_en: "Ribs bone side down. Medium heat." },
      { min: 30,  msg: "Sin prisa. La paciencia hace la diferencia.",            msg_en: "No rush. Patience makes the difference." },
      { min: 45,  msg: "Dar vuelta con cuidado. Deben estar doradas abajo.",     msg_en: "Flip carefully. Should be golden underneath." },
      { min: 65,  msg: "Rociar con la marinada. El aroma es increíble.",         msg_en: "Baste with marinade. The aroma is incredible." },
      { min: 75, msg: "Verificar que la carne se despegue del hueso.",          msg_en: "Check that the meat pulls away from the bone." },
      { min: 80, msg: "¡LISTAS! Se deben desprender solas. A disfrutar.",      msg_en: "DONE! Should fall off the bone on their own." },
    ],
  },
  {
    id: "lomo-cerdo", nombre: "Lomo de Cerdo", emoji: "🐷", color: "#EE9B00", tiempo: 80,
    eventos: [
      { min: 0,  msg: "Lomo a temperatura ambiente. Brasa media.",  msg_en: "Lomo at room temperature. Medium heat." },
      { min: 20, msg: "Rotar 90°. Dorar parejo todo el cilindro.",               msg_en: "Rotate 90°. Brown evenly all around." },
      { min: 40, msg: "Rotar 90°. Dorar parejo todo el cilindro.",               msg_en: "Rotate 90°. Brown evenly all around." },
      { min: 60, msg: "Rotar 90°. Dorar parejo todo el cilindro.",               msg_en: "Rotate 90°. Brown evenly all around." },
      { min: 75, msg: "Verificar cocción. Importante: cerdo debe estar bien cocido.", msg_en: "Check doneness. Important: pork must be well cooked." },
      { min: 80, msg: "¡LISTO! Reposar 5 min. Cortar en medallones.",           msg_en: "DONE! Rest 5 min. Slice into medallions." },
    ],
  },
  {
    id: "matambre-cerdo", nombre: "Matambre de Cerdo", emoji: "🐷", color: "#E67E22", tiempo: 40,
    eventos: [
      { min: 0,  msg: "Matambre de cerdo marinado. Brasa media-alta.",           msg_en: "Marinated pork matambre. Medium to high heat." },
      { min: 10, msg: "Cocción pareja. No apurar el fuego.",                     msg_en: "Even cooking. Don't rush the heat." },
      { min: 20, msg: "Dar vuelta. Debe estar dorado prolijo. Agregar un poco de fuego al corte",                  msg_en: "Flip. Should be neatly golden. Add a little heat to the cut" },
      { min: 30, msg: "Verificar que esté cocido en toda la superficie.",        msg_en: "Check it's cooked over the entire surface." },
      { min: 40, msg: "¡LISTO! Cortar en rodajas. Ideal como entrada.",         msg_en: "DONE! Slice into rounds. Great as a starter." },
    ],
  },
  {
    ...
    eventos: [
      ...
      { min: 65, msg: "Verificar que la carne se despegue del hueso.",           msg_en: "Check the meat pulls away from the bone." },
      { min: 75, msg: "¡LISTO! Debe desprenderse solo. Cortar entre huesos.",   msg_en: "DONE! Should pull apart on its own. Cut between bones." },
    ],
  },
  // ── ACHURAS ──────────────────────────────────────────────────────────────────
  {
    id: "chorizos", nombre: "Chorizos", emoji: "🌭", color: "#94452A", tiempo: 50,
    eventos: [
      { min: 0,  msg: "Pinchar los chorizos con tenedor. Fuego medio-alto.",           msg_en: "Pierce chorizos with a fork. Medium-High heat." },
      { min: 20,  msg: "Dar vuelta. Deben estar dorados de un lado.",             msg_en: "Flip. Should be golden on one side." },
      { min: 40, msg: "Girar un cuarto. Dorar todos los lados.",                 msg_en: "Quarter turn. Brown all sides." },
      { min: 45, msg: "Subir fuego 2 minutos para dorar la piel.",              msg_en: "Raise heat 2 minutes to crisp the skin." },
      { min: 50, msg: "¡LISTOS! Servir en pan con chimichurri.",                msg_en: "DONE! Serve in a roll with chimichurri." },
    ],
  },
  {
    id: "morcilla", nombre: "Morcilla", emoji: "🩸", color: "#3D0C02", tiempo: 30,
    eventos: [
      { min: 0,  msg: "NO pinchar la morcilla. Fuego alto.",                 msg_en: "DO NOT pierce the blood sausage. Very high heat." },
      { min: 15,  msg: "Dar vuelta con mucho cuidado. Tiene que estar entera.",   msg_en: "Turn very carefully. Must stay intact." },
      { min: 25, msg: "Girar para dorar el otro lado.",                          msg_en: "Rotate to brown the other side." },
      { min: 30, msg: "¡LISTA! Cortar en rodajas y servir con pan.",            msg_en: "DONE! Slice into rounds and serve with bread." },
    ],
  },
  {
    id: "mollejas", nombre: "Mollejas", emoji: "🫀", color: "#6A040F", tiempo: 75,
    eventos: [
      { min: 0,  msg: "Mollejas limpias y blanqueadas. Fuego medio-alto.",       msg_en: "Cleaned and blanched sweetbreads. Medium-high heat." },
      { min: 25, msg: "Dar vuelta. Deben estar crocantes por abajo.",            msg_en: "Flip. Should be crispy on the bottom." },
      { min: 50, msg: "Girar para dorar todos los lados.",                       msg_en: "Rotate to brown all sides." },
      { min: 60, msg: "Girar",                           msg_en: "Rotate." },
      { min: 75, msg: "¡LISTAS! Servir inmediatamente con limón.",              msg_en: "DONE! Serve immediately with lemon." },
    ],
  },
  {
  ...
  {
    id: "riñon", nombre: "Riñón", emoji: "🫘", color: "#884EA0", tiempo: 70,
    eventos: [
      { min: 0,  msg: "Riñones limpios. Brasa baja. Cocción lenta para no endurecer.",            msg_en: "Clean kidneys. Low heat. Slow cooking to avoid toughening." },
      { min: 20,  msg: "Dar vuelta.",                        msg_en: "Flip." },
      { min: 35,  msg: "Dar vuelta.",                        msg_en: "Flip." },
      { min: 50,  msg: "Dar vuelta. Verificar cocción. No deben quedar crudos adentro.",      msg_en: "Check doneness. Shouldn't be raw inside." },
      { min: 60, msg: "¡LISTOS! Exprimir limón generoso. Comer ya.",            msg_en: "DONE! Generous squeeze of lemon. Eat now." },
    ],
  },
  {
  ...
  // ── VIP ──────────────────────────────────────────────────────────────────────
  {
    ...
    eventos: [
      { min: 0,   msg: "Lechón a la parrilla. Brasa baja y paciencia. Poner boca abajo con fuego mayor emnte en las puntas no tanto en el centro",              msg_en: "Grilled suckling pig. Low embers and patience. Place upside down with the fire mostly on the ends, not so much in the center." },
      { min: 40,  msg: "Controlar intensidad fuego. Rociar con salmuera.",          msg_en: "Check fire intensity. Baste with brine." },
      { min: 60,  msg: "Controlar intensidad fuego. Rociar con salmuera. El cuero debe ir dorándose.",          msg_en: "Check fire intensity. Baste with brine. Skin should be browning." },
      { min: 80,  msg: "Controlar intensidad fuego. Rociar con salmuera.",          msg_en: "Check fire intensity. Baste with brine." },
      { min: 100,  msg: "Controlar intensidad fuego. Rociar con salmuera. El cuero debe estar dorado.",          msg_en: "Check fire intensity. Baste with brine. Skin should be golden." },
      { min: 120, msg: "Dar vuelta completo. El aroma lo dice todo.",            msg_en: "Flip completely. The aroma says it all." },
      { min: 140,  msg: "Controlar intensidad fuego. Rociar con salmuera.",          msg_en: "Check fire intensity. Baste with brine." },
  ...
  },
  {
    ...
    eventos: [
      ...
      { min: 35, msg: "Dar vuelta. Piel hacia abajo ahora.",                    msg_en: "Flip. Skin side down now." },
      { min: 50, msg: "Rociar con chimichurri. Verificar cocción.",             msg_en: "Baste with chimichurri. Check doneness." },
      { min: 60, msg: "¡LISTO! Jugo transparente al pinchar: listo.",          msg_en: "DONE! Clear juices when pierced: it's ready." },
    ],
  },
  {
    id: "cordero", nombre: "Cordero", emoji: "🐑", color: "#8e44ad", tiempo: 110, vip: true,
    eventos: [
      { min: 0,  msg: "Cordero. Brasa baja-media constante. Siempre poner mas fuego en cada una de las puntas",                 msg_en: "Lamb. Low to medium constant embers. Always add more fire to each end." },
      { min: 25,  msg: "Controlar intensidad fuego. Rociar con salmuera (opcional).",          msg_en: "Check fire intensity. Baste with brine (optional)." },
      { min: 60,  msg: "Controlar intensidad fuego. Rociar con salmuera (opcional). El cuero debe ir dorándose.",          msg_en: "Check fire intensity. Baste with brine (optional). Skin should be browning." },
      { min: 80, msg: "Girar. Controlar fuego",                msg_en: "Rotate. Check fire" },
      { min: 95, msg: "Pinchar: debe estar tierno. Casi listo.",                msg_en: "Pierce: should be tender. Almost done." },
      { min: 110, msg: "¡LISTO! Reposar 10 min. Servir con menta.",             msg_en: "DONE! Rest 10 min. Serve with mint." },
    ],
  },
  {
    id: "picanha", nombre: "Picanha", emoji: "🥩", color: "#922b21", tiempo: 50, vip: true,
    eventos: [
      { min: 0,  msg: "Picanha con grasa hacia arriba. Brasa media-alta.",            msg_en: "Picanha fat side up. Medium-High heat." },
      { min: 25,  msg: "Dar vuelta. La grasa se derrite sola.",                  msg_en: "Flip. The fat renders on its own." },
      { min: 40, msg: "Sellar fuerte los últimos minutos.",                     msg_en: "Sear hard in the last few minutes." },
      { min: 50, msg: "¡LISTA! Cortar en contra de la fibra en tiras.",        msg_en: "DONE! Slice against the grain into strips." },
    ],
  },
];
...
export const CARBON_NOTIFS = {
  adjustable: [
    ...
    { min: 35, msg: "Tip Fuego en general: Achuras fuego medio-alto y Carnes fuego medio. Controlar si el fuego anda bien sino agregar", msg_en: "General Fire Tip: Offal over medium-high heat and meats over medium heat. Check if the fire is working properly; if not, add more heat." },
    { min: 45, msg: "Control de carbón: mantené la brasa pareja especialmente para los cortes largos.", msg_en: "Charcoal check: keep the coals even especially for the longer cuts." },
    { min: 60, msg: "Revisión de carbón. Asegurate tener brasa suficiente.",                     msg_en: "Charcoal check. Make sure you have enough coals." },
    { min: 75, msg: "Revisión de carbón. Asegurate tener brasa suficiente.",                     msg_en: "Charcoal check. Make sure you have enough coals." },
    { min: 95, msg: "Revisión de carbón. Asegurate tener brasa suficiente.",                     msg_en: "Charcoal check. Make sure you have enough coals." },
    { min: 115, msg: "Revisión de carbón. Asegurate tener brasa suficiente.",                     msg_en: "Charcoal check. Make sure you have enough coals." },
    { min: 135, msg: "Revisión de carbón. Asegurate tener brasa suficiente.",                     msg_en: "Charcoal check. Make sure you have enough coals." },
    { min: 165, msg: "Revisión de carbón. Asegurate tener brasa suficiente.",                     msg_en: "Charcoal check. Make sure you have enough coals." },
  ...
  fixed: [
    ...
    { min: 80, msg: "Control de carbón. Mantener calor uniforme es clave.",                             msg_en: "Charcoal check. Keeping uniform heat is key." },
    { min: 100, msg: "Revisión de brasas. Distribuí el carbón de manera pareja.",                        msg_en: "Coals check. Spread the charcoal evenly." },
    { min: 120, msg: "Control de carbón. Mantener calor uniforme es clave.",                             msg_en: "Charcoal check. Keeping uniform heat is key." },
    { min: 140, msg: "Revisión de brasas. Distribuí el carbón de manera pareja.",                        msg_en: "Coals check. Spread the charcoal evenly." },
  ],
};
